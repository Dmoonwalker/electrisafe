...
<body>
    ...
    <div class="jumbotron jumbotron-fluid" id="banner" style="background-image: url(img/pole.jpg);">
        <div class="container text-center text-md-left">
            ...
            <h1 data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="display-4 text-white font-weight-bold my-5">
            	A New Way<br>
            	To Secure Electric Grid
            </h1>
            <p data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="lead text-white my-4">
              ElectriSafe, offers a smart electronic method for licensing poles,<br>this solution provides real time, cost-effective tracking system to ensure proper safety
            </p>
